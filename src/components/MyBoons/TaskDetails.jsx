                ...
                <Container maxWidth='md' className={classes.root}>
                            ...
                            <Grid
                                ...
                                <div>
                                    ...
                                    <Typography>
                                        {user._id !== task.boonee._id ? (
                                            <b>
                                                Boonee: {task.boonee.userName}
                                            </b>
                                        ) : (
                                            <b>
                                                Booner: {task.booner.userName}
                                            </b>
                                        )}
                                    </Typography>
                                    ...
                                    {task.status === "accepted" &&
                                        user._id !== task.boonee._id && (
                                            <div>
                                                <p>
                                                    You accepted this task and
                                                    it will be on the{" "}
                                                    {task.date.slice(0, 10)},
                                                    you can still cancel it 6
                                        ...
                                        user._id === task.boonee._id && (
                                            <div>
                                                <p>
                                                    ...
                                                    requested this task. Let's
                                                    wait for
                                                    {task.booner.userName}'s
                                                    answer! You can still cancel
                                                    this task.
                                                </p>
                                                <Grid item xs={4}>
                                                    <Tooltip
                    ...
                    report a problem */}
                                    ...
                                    {task.status === "finished" &&
                                        user._id === task.boonee._id && (
                                            <p>
                                                We hope you were happy with this
                                                user. Please let us know with a
                                                rating.
                        ...
                        <Dialog
                            ...
                            <DialogContent>
                                <DialogContentText id='alert-dialog-description'>
                                    We are glad you found a task you like!
                                    Please confirm if you want to accept it!
                                </DialogContentText>
                            </DialogContent>
                            <DialogActions>
                    ...
                    <Dialog
                        ...
                        <DialogContent>
                            <DialogContentText id='alert-dialog-description'>
                                Please confirm that this task took place. If you
                                had any issues, contact our customer support!
                                Don't forget to rate {task.booner.userName}!
                            </DialogContentText>
                        </DialogContent>
                        <DialogActions>
                            <Button color='primary'>Changed my mind</Button>
