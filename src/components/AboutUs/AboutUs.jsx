    ...
    <>
      <Container maxWidth="lg" className={classes.root}>
        ...
        <Grid container spacing={3}>
          <Box item xs={12} className={classes.hero} component={Grid} boxShadow={8}>
            <Grid item xs={5}>
        ...
        <Grid container spacing={3} >
          <Grid item xs={12} md={4}>
            <Card className={classes.root}>
              ...
              <CardActions disableSpacing>
                <Link a href="https://github.com/mizzrawr" target="_blank" rel="noopener" >
                <IconButton aria-label="add to favorites">
                  <GitHubIcon />
                </IconButton>
                </Link>
                <Link a href="https://www.linkedin.com/in/cindy-giron/" target="_blank" rel="noopener">
          ...
          <Grid item xs={12} md={4}>
            <Card className={classes.root}>
              ...
              <CardActions disableSpacing>
                <Link a href="https://github.com/Zarzarius" target="_blank" rel="noopener">
                <IconButton aria-label="add to favorites">
                  <GitHubIcon />
                </IconButton>
                </Link>
                <Link a href="https://www.linkedin.com/in/azael-alonso-campana-5b1a49207/" target="_blank" rel="noopener">
                <IconButton aria-label="share">
                  <LinkedInIcon />
                </IconButton>
                </Link>
          ...
          <Grid item xs={12} md={4}>
            <Card className={classes.root}>
              ...
              <CardActions>
                <Link a href="https://github.com/encsooo" target="_blank" rel="noopener">
                <IconButton aria-label="add to favorites">
                  <GitHubIcon />
                </IconButton>
                </Link>
                <Link a href="https://www.linkedin.com/in/enikoveszelka/" target="_blank" rel="noopener">
                <IconButton aria-label="share">
                  <LinkedInIcon />
                </IconButton>
                </Link>
        ...
        <Grid mb={3}  container direction="column"  >
            <Card className={classes.lastCard} elevation={8} >
              ...
              <CardActions className={classes.icons} disableSpacing>
                ...
                {/* First first icon */}
                <Link a href="https://github.com/BOON-Project" target="_blank" rel="noopener" >
                <IconButton aria-label="add to favorites">
                ...
                {/* second icon */}
                <Link a href="https://linkedin.com" target="_blank" rel="noopener" >
                <IconButton aria-label="share" >
                ...
                <Link a href="https://twitter.com" target="_blank" rel="noopener">
                <IconButton aria-label="share">
